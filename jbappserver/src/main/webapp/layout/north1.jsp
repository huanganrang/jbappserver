...
<div style="position: absolute; right: 0px; bottom: 0px;">
	...
	<a href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'cog'" onclick="javascript:logoutFun(true);">注销</a>
</div>
...
<div id="layout_north_kzmbMenu" style="width: 100px; display: none;">
	<div class="menu-sep"></div>
	<div onclick="currentUserRole();">我的用户组</div>
	<!-- <div class="menu-sep"></div>

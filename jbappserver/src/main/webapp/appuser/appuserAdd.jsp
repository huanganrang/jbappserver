...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/appuserController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td>
					<input class="span2" name="group" type="text" class="span2"/>
					</td>							
				</tr>	
				<tr>	
					<th><%=Tappuser.ALIAS_FROM_IP%></th>	
					<td>
					<input class="span2" name="fromIp" type="text" class="span2"/>
					</td>							
				</tr>	
			</table>		
		</form>

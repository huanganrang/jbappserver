...
<%
String url = request.getContextPath()+"/appClientController/refreshPerm";
%>
...
<script type="text/javascript">
	$(function() {
		...
		$('#refreshPerm_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#refreshPerm_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="refreshPerm_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						...
						<input type="button"
							value="提交" onclick="javascript:$('#refreshPerm_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
				<div id="refreshPerm_result">
				</div>
			<div>
				结果说明：1、json格式<br/>

...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=uVkZBmjLC0KGflQtsXRc4rh4"></script>
...
<body>
	...
	<jsp:include page="user/login1.jsp"></jsp:include>

	<div id="index_layout">
		<div data-options="region:'north',href:'${pageContext.request.contextPath}/layout/north1.jsp'" style="height: 70px; overflow: hidden;" class="logo"></div>
		<div data-options="region:'west',href:'${pageContext.request.contextPath}/layout/west.jsp',split:true" title="模块导航" style="width: 150px; overflow: hidden;"></div>

...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/jbRepairCheckController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td>
					<input class="span2" name="repairDate" type="text" onclick="WdatePicker({dateFmt:'<%=TjbRepairCheck.FORMAT_REPAIR_DATE%>'})"  maxlength="0" class="" />
					</td>							
				</tr>	
				<tr>	
					<th><%=TjbRepairCheck.ALIAS_REPAIR_ORDER%></th>	
					<td>
											<input class="span2" name="repairOrder" type="text"/>
					</td>							
					<th><%=TjbRepairCheck.ALIAS_REPAIR_PEOPLE%></th>	
					<td>
											<input class="span2" name="repairPeople" type="text"/>
					</td>							
				</tr>	
				<tr>	
					<th><%=TjbRepairCheck.ALIAS_REPAIR_PHONE%></th>	
					<td>
											<input class="span2" name="repairPhone" type="text"/>
					</td>							
				...
				<tr>	
					...
					<td>
					<input class="span2" name="addtime" type="text" onclick="WdatePicker({dateFmt:'<%=TjbRepairCheck.FORMAT_ADDTIME%>'})"  maxlength="0" class="" />
					</td>							
				</tr>	
			</table>		
		</form>
